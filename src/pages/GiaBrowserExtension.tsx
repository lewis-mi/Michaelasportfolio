...
import { imgGroup } from "../imports/svg-3uv74";
              ...
              <div className="font-['Poppins:Medium',_sans-serif] font-medium text-base md:text-lg text-[#333333] tracking-tight leading-relaxed space-y-4">
                ...
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li>Further refine tone for realism</li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        <footer className="w-full border-t border-[rgba(0,0,0,0.15)] mt-12 md:mt-20">
          <div className="px-6 md:px-12 lg:px-24 py-12 md:py-16 lg:py-20">
            <div className="max-w-[1440px] mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
              <h2 className="font-['Poppins:Regular',_sans-serif] font-normal text-[40px] text-[#333333] tracking-tight">Contact Me</h2>
              <button 
                ...
                <div className="relative shrink-0 size-[24px]">
                  <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border overflow-clip relative rounded-[inherit] size-[24px]">
                    <div className="absolute contents inset-0">
                      <div className="absolute contents inset-0">
                        <div className="absolute inset-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px] mask-size-[24px_24px]" style={{ maskImage: `url('${imgGroup}')` }}>
